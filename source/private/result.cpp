...
#define TEXTURE_WIDTH_LOGO			(900)			// ロゴサイズ
...
void DrawResult(void)
{
	...
	// リザルトのロゴを描画
	{
		...
		// １枚のポリゴンの頂点とテクスチャ座標を設定
		SetSprite(g_VertexBuffer, 960, 200, TEXTURE_WIDTH_LOGO, TEXTURE_HEIGHT_LOGO, 0.0f, 0.0f, 1.0f, 1.0f);
	...
	// スコア表示
	{
		...
		for (int i = 0; i < SCORE_DIGIT; i++)
		{
			...
			float px = 1050.0f - i*pw;	// スコアの表示位置X
			float py = 600.0f;			// スコアの表示位置Y
